...
var Enemy = function(name, hp, lev){
  this.enemyName = name;
  this.hp = hp;
  this.level = lev
}
...
//Enemy Objects
var enemy1 = new Enemy("Fox", 30, 4);
var enemy3 = new Enemy("Le Leader", 60, 11);

// Order of commands
// [talk, pickup, go, run, lookat, check]

var Object = function(name, description, talk, pickup, go, fight, inter, lev) {
...
//All Objects
//level one
var planet = new Object("planet", "The planet is terrestrial and looks a lot like your old home. You feel a little nostalgic.", "You sing a little love song to the planet.", "You cannot pickup the planet.", "level-up", "You fire your ship's laser at the planet. The laser vanishes once it hits the atmosphere.", "You take a selfie with the planet.", 0);

var radio = new Object("space radio", "Your radio only cost you a couple of space bucks at the local space thrift store. What a deal!", "You sing along with the song on the space radio, just a little out of key.", "The space radio is heavier than it looks.", "You walk towards the space radio, but there is't anything interesting nearby.", "You think breaking your space radio is a bad idea.", "You turn the music up on your space radio.", 0);

//level two
var north = new Object("north", "The pine trees look a little softer than the rocks.", "You yell at the trees for not being a nice little clearing to land in.", "You cannot pickup the trees.", "double-level-up", "You fire lasers, and they burn the tops of the trees, but are otherwise ineffective.", "You take a selfie with the trees, wasting valuable time.", 1);

var south = new Object("south", "The rocks look really jagged and hard. Maybe the trees are a better decision.", "You yell at the rocks for not being a clearing.", "You cannot pickup the rocks.", "level-up", "You shoot lasers at the rocks, and miss.", "You take a selfie with the rocks, wasting valuable time.", 1);

//level three
var levelThreeButton = new Object("switch", "This button will open the cockpit in any emergency", "You tell the button to open the cockpit, but you remember that you forgot to install voice control. Still on the to-do list...", "You try to pickup the button, but it's difficult and it doesn't work.", "You're already next to the button", "You try to smash the button, but you miss.", "double-level-up", 2);

var bunk = new Object("bunk", "Your bed is a little lumpy, but the blankets are old and familiar, smelling a little like home.", "You tell your stuffed carrot that you love them.", "You try to pick up the bunk but it is bolted to the deck.", "You go to your bed to lie down but its not as comfortable as it looks.", "You throw all the blankets off the bed and onto the floor.", "You try to take a nap but the sense of adventure makes you restless.", 2);

// level four
var levelFourButton = new Object("button", "This button will open the cockpit in any emergency.", "You tell the button to open the cockpit, but you remember that you forgot to install voice control. Still on the to-do list...", "You try to pickup the button, but it's difficult and it doesn't work.", "You're already next to the button.", "You try to smash the button, but you miss.", "level-up", 3);

var carrots = new Object("carrots", "Your carrots look a little beat up from the crash but still edible.", "You tell your carrots how sorry you are that they got beat up.", "You pick up your carrots and put them in your pocket.", "You walk towards your carrots and accidentally step on them.", "You throw your carrots at the wall and break them.", "add-to-inventory", 3);

// level five
var turnip = new Object ("turnip", "The turnip is about a foot tall and a foot wide. The stalks on its head are styled into a very fashionable 'hair-do'. Its torso is a lovely shade of purple.", "The turnip asks again for your help." , "The turnip is indignant that you picked it up. This is wildly offensive in turnip culture.", "Don't move! There is a fox with a laser pointed at you.", "The turnip bites your foot and insists the fox is the bad guy.", "The turnip asks for your help again!", 4);
...
// level six
var forest = new Object("forest", "The forest is dense with trees.", "You whistle and it sounds like the forest whistles back.", "You pickup a stick from the ground and throw it deep into the forest.", "level-up", "You punch a tree and hurt your paw!", "You take a selfie with the forest, wasting valuable time.", 5);

// level seven
var quietly = new Object("sneak quietly", "You could sneak quietly if you decide to 'go' quietly.", "You whisper to yourself about how sad it is that the foxes are eating turnips.", "You cannot pickup abstract things.", "level-up", "You punch the air as a warm up.", "You take a selfie, quietly, with the camp behind you, wasting valuable time.", 6);

var foxes = new Object("fight the foxes", "They seem to be talking about something your can't quite hear from here.", "You can't talk to them from here, it would blow your cover!", "You cannot pickup these foxes.", "double-level-up", "double-level-up", "You take a selfie with the foxes, wasting valuable time.", 6);

// level eight
var tree = new Object ("tree", "The tree is very slippery and tall. It looks like the lowest branches are out of your reach.", "The tree has nothing to say.", "You are strong, but not THAT strong!", "You go to the tree, but it is too slippery to climb.", "You have other enemies to think about right now!", "You try to climb the tree, but it is too slippery to climb.", 7);

var levelEightRock = new Object ("large rock", "The rock is a bit shorter than you and very wide, perfect for crouching behind in a laser gun fight.", "The rock suggests you stop talking to rocks.", "The rock kindly asks you to put it down before you hurt yourself. It is very heavy.", "double-level-up", "You have other enemies to think about right now.", "You ask the rock if it is on Linked-In and if it will add you as a network.", 7);

// level nine
var stick = new Object ("stick", "The stick is inches from your paw, and looks a little brittle.", "The stick doesn't have much to say to you.", "You pick up the stick, but it breaks easily in your paw.", "You are already very close to the stick.", "You cannot do that right now.", "You pick up the stick, but it breaks easily in your hands.", 8);

var levelNineLaserGun = new Object ("laser gun", "Your trusty laser gun, The Unforgettable, is quite a way behind you, but you might be able to reach it in time.", "You call out to your last gun, but it doesn't respond.", "level-up", "level-up", "Your stick broke and your gun is still behind you!", "level-up", 8);

// level ten
var levelTenRock = new Object ("sharp rocks", "The rocks are in a small pile nearby, and they look very sharp.", "You ask the rocks to cut your ropes, but they do not respond.", "You can't pick up the rocks when you are tied up!", "You try to wiggle your way towards the rocks, but find it too difficult.", "You cannot do this right now.", "You try to wiggle your way towards the rocks, but find it too difficult.", 9);

var rope = new Object("rope", "The rope is thick, but its no match for your sharp teeth.", "The rope does not talk.", "You cannont pick up the rope because it is wrapped around you.", "You cannot go anywhere.", "You wriggle fiercly, but the rope does not give.", "level-up", 9);

// level eleven
var microphone = new Object("microphone", "The microphone is attached to a long cord. It is very similar to a lasso or a ball and chain.", "Your voice is magnified to the crowd and startles you.", "level-up", "You go towards the microphone and knock it off the stand", "You hit the microphone and knock it off the stand", "You take a selfie with the crowd of Foxes", 10);

var boilingWater = new Object("boiling water", "The pot of boiling water is large and black, there is steam rising from the top. It looks like it could badly burn your enemies.", "You tell the babies hanging above that you are there to rescue them.", "You try to pick up the pot but its too large and the hot water starts to overflow almost burning you.", "You walk towards the boiling water but the steam makes it hard to see.", "You attack the pot of boiling water and it almost spills all over you!", "You reach towards the pot of boiling water and it almost spills all over you!", 10);

var leader = new Object("Le Leader du Les Foxes", "Le Leader du Les Foxes is wearing his beret proudly.", "You taunt him with bunny puns.", "You can't pick him up at the moment.", "You're already pretty close.", "fight3", "You try to take a selfie with Le Leader du Les Foxes, but he stops you before you waste valuable time.", 11);

// level twelve
var zipper = new Object("zipper", "The zipper pull is hanging right below Le Leader's beret. The zipper spans the length of the space suit.", "Zippers cant talk you fool!", "What are you trying to do?", "level-up", "level-up", "level-up", 12);

var outside = new Object("outside", "Behind Le Leader du les Foxes is a clear path towards the forest, and behind you is a crowd of foxes.", "You won't be able to talk your way out of this situation!", "There is nothing in the area that might help you escape.", "You try to run, but a group of foxes block your path.", "You try fighting your way through, but there are too many foxes!", "You try running, but a group of foxes block your path. You take a selfie with them wasting valuable time!", 12);

// level thirteen
var foxJail = new Object("fox jail", "Fox jail is a prison established 300 years ago by the founders of Fox City. The crime rate in Fox City is quite low, so it is not highly populated. However, the leaders of Fox City ensure the best guards patrol the prison.", "level-up", "You cannot lift a giant prison. What are you trying to do?", "You need to return the baby turnips to their parents!", "The foxes are no longer the bad guys.", "level-up", 13);
...
//level fifteen
var ship = new Object("ship", "The brand new ship modifications make it shine just like an KaratX90T!", "You pat your new ship and say, 'Good Karat...'", "You cannot lift your ship!", "game-end", "You don't want to fight this brand new ship.", "game-end", 14);
...
var level11 = new Level(11, "You're not known as Riley, Space Rabbit Extraordinaire, for nothing! Using your teeth to escape easily, you happen to notice a conveniently left behind regulation FiSSwL space suit in your size, even accomodating your luxurious rabbit coat. Swiftly, you jump into the costume and hop with haste to the meeting place. Once you reach the Foxes with Space Suits and Lasers' gathering, you make your way to the front of the crowd listening to Le Leader du les Foxes recite the recipe. 'First, bring ze water to ze boiling, zhen add ze salt and ze pepper.' There is a pot of boiling water with the baby turnips hanging above. Placing yourself between the babies and the head honcho, you challenge the fox to a fight. This time remembering your trusty laser, the Unforgettable, you realize, too late, that your weapon is still with the Foxes in Space Suits with Lasers who captured you. Available to use as weapons nearby are the <span class='text-object'>[microphone]</span> and the <span class='text-object'>[boiling water]</span> for the soup");
