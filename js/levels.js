...
//All Levels
var level1 = new Level(1, "You are Riley, Space Rabbit Extraodinaire, exploring new and old worlds in the farthest reaches of space. Your ship, a KaratX70T, is an old version, but trusty, and quite frankly, smells pretty dang good. Out of your window, you see a terrestrial planet, one you have never visited. You're munching on a carrot and listening to the newest hit space pop song, when your console begins to blink. A distress beacon! You press the play button and listen. 'Anyone, please help! We are in trouble. We are being attacked! Our little ones! They are taking them!' The message quickly turns to static. Your computer tells you the message is coming from the <span class='text-object'>[planet]</span> below. Will you respond to the message, or <span class='text-object'>[ignore]</span> the cries and continue listening to that catchy new jam?");

var level2 = new Level(2, "You change course toward the planet. Upon entering the atmosphere, you begin to feel turbulence. This isn't normal. An error message begins to display on your computer's output screen. The engines are losing power drastically! There must be something with the atmosphere here. Something terrible. Your engines begin to completel`y fail and the ship starts to drop. You press the 'Glide' button above your head and the KaratX70T sprouts long gliding wings. The forest below is dense and there are no clearings to crash land in. To the <span class='text-object'>[north]</span> there are dense pines, and to the <span class='text-object'>[south]</span> you see what looks to be sharp, jagged rocks.");
