...
var levelThreeButton = new Object("emergency switch", "This button will open the cockpit in any emergency", "You tell the button to open the cockpit, but you remember that you forgot to install voice control. Still on the to-do list...", "You try to pickup the button, but it's difficult and it doesn't work.", "You're already next to the button", "You try to smash the button, but you miss.", "double-level-up");
...
var rope = new Object("rope", "The rope is thick, but your sharp teeth are no match for it.", "The rope does not talk.", "You cannont pick up the rope because it is wrapped around you.", "You cannot go anywhere.", "You wriggle fiercly, but the rope does not give.", "level-up");

// level eleven
var microphone = new Object("microphone", "The microphone is attached to a long cord. It is very similar to a lasso or a ball and chain.", "Your voice is magnified to the crowd and startles you.", "fight3", "You go towards the microphone and knock it off the stand", "You hit the microphone and knock it off the stand", "level-up");

var boilingWater = new Object("boiling water", "The pot of boiling water is large and black, there is steam rising from the top. It looks like it could badly burn your enemies.", "You tell the babies hanging about that you are there to rescue them.", "You try to pick up the pot but its too large and the hot water starts to overflow almost burning you", "You walk towards the boiling water but the steam makes it hard to see.", "You attack the pot of boiling water and it almost spills all over you!", "You reach towards the pot of boiling water and it almost spills all over you!");
...
<<<<<<< HEAD
var level2 = new Level(2, "You change course to the planet. Upon entering the atmosphere, you begin to feel turbulence. Something doesn't feel right! An error message displays on your control console. The engines are losing power! Your ship plummets towards the planet below. <br>You press the 'Glide' button above your head, and the KaratX70T tries to slow its descent. The forest below is dense and there are no clearings to safely land in. <br>To the <span class='text-object'>[north]</span>, there is a dense forest. To the <span class='text-object'>[south]</span>, you see what looks to be sharp, jagged rocks.");

var level3 = new Level(3,"You head south and crash into the rocks, your ship falling to pieces. You wake with a headache and your ears are bruised. There are sparks shooting from your computer, and the smell of burning fur and melted plastic fills your little nose. It's hard to see out your window through the smoke, but you make out a few moving shadows along the edge of the forest. Those shadows don't look good! There is an <span class='text-object'>[emergency button]</span> to open the cockpit, but your <span class='text-object'>[bunk]</span> is still intact and a restorative nap sounds good right about now. What do you do?");
=======
var level2 = new Level(2, "Your sense of adventure drives you to answer the call for help! You change course to the planet. Upon entering the atmosphere, you begin to feel turbulence. Something doesn't feel right! An error message displays on your control console. The engines are losing power! Your ship plummets towards the planet below. You press the 'Glide' button above your head, and the KaratX70T tries to slow its descent. The forest below is dense and there are no clearings to safely land in. To the <span class='text-object'>[north]</span>, there is a dense forest. To the <span class='text-object'>[south]</span>, you see what looks to be sharp, jagged rocks.");

var level3 = new Level(3,"You crash into the rocks with a. You wake with a headache and your ears are aching. All you remember is a loud bang and everything going black. There are sparks coming from your computer and it smells a lot like burning fur. There is an emergency <span class='text-object'>[switch]</span> to open the cockpit. It's hard to see out your window, but you make out a few moving shadows amongst the typical shadows of forest trees. Those shadows don't look good, but your <span class='text-object'>[bunk]</span> is still intact and a restorative nap sounds good right about now.");
>>>>>>> sf

//Choice of North
var level4 = new Level(4, "You head north and crash into the forest below. You wake with a headache and your ears are bruised. There are sparks shooting from your computer, and the smell of burning fur and melted plastic fills your little nose. There is an <span class='text-object'>[emergency switch]</span> to open the cockpit. It's hard to see out your window, but you make out a few moving shadows. You also make out some <span class='text-object'>[carrots]</span> on the deck floor that still look edible, and a snack sounds good right about now.");
...
var level13 = new Level(13, "Le Leader du Les Foxes, ducks with a twirl and tries to kick your feet from under you. As they spin, you notice a <span class='text-object'>[zipper]</span> at the crown of their space helmet. You are also surrounded by more foxes than you can handle, and wonder if you should <span class='text-object'>[flee]</span> to regroup and fight the boss one-on-one another time.")

var level14 = new Level(14, "You, Riley, Space Rabbit Extraordinaire, use your powerful legs to jump behind Le Leader and tug the zipper down. Deflating, the space suit sinks to the legs of a--What is this? A turnip! A gasp resonates through the crowd. Confused, the foxes begin to disperse, muttering among themselves, 'we didn't even like turnips anyway' and 'we were only doing it because that guy said it was cool.' A few foxes, embarassed by the whole ordeal, hand you your trusty laser gun, the Unforgettable, (which you've totally forgotten about), ask you what they should do with the treachorous ex-leader of the FiSSwL. You have a couple ideas in mind. They could lock the turnip up in <span class='text-object'>[fox jail]</span>, they could save him for <span class='text-object'>[dinner]</span>.");
