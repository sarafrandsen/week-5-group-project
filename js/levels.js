...
var level2 = new Level(2, "You change course toward the planet. Upon entering the atmosphere, you begin to feel turbulence. This isn't normal. An error message begins to display on your computer's output screen. The engines are losing power drastically! There must be something with the atmosphere here. Something terrible. Your engines begin to completely fail and the ship starts to drop. You press the 'Glide' button above your head and the KaratX70T sprouts long gliding wings. The forest below is dense and there are no clearings to crash land in. To the <span class='text-object'>[north]</span> there are dense pines, and to the <span class='text-object'>[south]</span> you see what looks to be sharp, jagged rocks.");
